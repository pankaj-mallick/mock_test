...
<table width="700" height="500" border="0" align="center" cellspace="0" bgcolor="#4768c0">
<tr>
	<td width="200" rowspan="2" valgin="top">
	...
	<%
		...
		if("no".equals(login))
			...
			out.println("Click for <a href='/WebContent/login.jsp?type=User'><font color= yellow>Login</a></font>");
			else
			{
